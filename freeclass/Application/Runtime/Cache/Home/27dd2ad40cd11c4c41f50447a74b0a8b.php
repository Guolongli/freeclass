...
<link href="/freeclass/Public/self/css/AddCourse.css" rel="stylesheet">
<link href="/freeclass/Public/self/css/InputOption.css" rel="stylesheet">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <table data-toggle="table">
                    ...
                    <?php $__FOR_START_1759201387__=0;$__FOR_END_1759201387__=5;for($i=$__FOR_START_1759201387__;$i < $__FOR_END_1759201387__;$i+=1){ ?><tr>
                            <td>
                                第<?php echo ($i+1); ?>节
                            </td>
                            <?php $__FOR_START_467302646__=0;$__FOR_END_467302646__=7;for($j=$__FOR_START_467302646__;$j < $__FOR_END_467302646__;$j+=1){ ?><td>
                                    <span id="addCourse" class="glyphicon glyphicon-s glyphicon-plus addCourse" data-toggle="modal" data-target="#myModal1" title="<?php echo ($i+$j*5+1); ?>" onclick="getTime(this.title);"></span>
                                </td><?php } ?>
                        </tr><?php } ?>
                </table>
            </div>
    ...
    <div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form role="form" action="<?php echo U('Course/AddCourse',array('action'=>'addcourse'));?>" method="post" onsubmit="return CheckSubmit();">

                    <div class="form-group">
                        <label>请输入要添加的课程名</label>
                        <input type="text" id="coursename" name="coursename" class="form-control"  placeholder="请输入课程名">
                    </div>
                    <div class="form-group">
                        <label class="weeklabel">请选择课程周次范围</label>
                        <select class="form-control weekselect" id="week1" onchange="GetFAnWei();">
                            <?php $__FOR_START_1427953419__=1;$__FOR_END_1427953419__=21;for($i=$__FOR_START_1427953419__;$i < $__FOR_END_1427953419__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
                        </select>
                        <span class="weekfan">到</span>
                        <select class="form-control weekselect" id="week2" onchange="GetFAnWei();">
                            <?php $__FOR_START_1067142588__=1;$__FOR_END_1067142588__=21;for($i=$__FOR_START_1067142588__;$i < $__FOR_END_1067142588__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
                        </select>
...
<script src="/freeclass/Public/self/js/AddCourse.js"></script>
</body>
