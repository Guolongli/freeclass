...
<div class="main">
    <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
        <div class="login-panel panel panel-default">
            <div class="panel-heading" align="center">空课统计管理员登录</div>
            <div class="panel-body">
                <form role="form" action="<?php echo U('Index/Load');?>" method="post">
                    <fieldset>
                        <div class="form-group">
                            <input class="form-control" placeholder="请输入管理员账号" name="user" type="text" style="text-align: center">
                        </div>
                        <div class="form-group">
                            <input class="form-control" placeholder="请输入管理员密码" name="pwd" type="password" style="text-align: center">
                        </div>
